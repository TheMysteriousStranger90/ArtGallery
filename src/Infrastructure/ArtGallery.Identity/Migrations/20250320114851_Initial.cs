        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ArtistImage_Artist_ArtistId",
                        column: x => x.ArtistId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Biography_Artist_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Artist",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFavoriteArtist_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaintingExhibition", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaintingExhibition_Exhibition_ExhibitionId",
                        column: x => x.ExhibitionId,
                        principalTable: "Exhibition",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaintingExhibition_Painting_PaintingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaintingTag", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaintingTag_Painting_PaintingId",
                        column: x => x.PaintingId,
                        principalTable: "Painting",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaintingTag_Tag_TagId",
                        column: x => x.TagId,
                        principalTable: "Tag",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserFavoritePainting_Painting_PaintingId",
                        column: x => x.PaintingId,
                        principalTable: "Painting",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFavoritePainting_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtistImage_ArtistId",
                table: "ArtistImage",
                column: "ArtistId");

            migrationBuilder.CreateIndex(
                name: "IX_Biography_ArtistId",
                table: "Biography",
                column: "ArtistId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaintingExhibition_ExhibitionId",
                table: "PaintingExhibition",
                column: "ExhibitionId");

            migrationBuilder.CreateIndex(
                name: "IX_PaintingExhibition_PaintingId",
                table: "PaintingExhibition",
                column: "PaintingId");

            migrationBuilder.CreateIndex(
                name: "IX_PaintingTag_PaintingId",
                table: "PaintingTag",
                column: "PaintingId");

            migrationBuilder.CreateIndex(
                name: "IX_PaintingTag_TagId",
                table: "PaintingTag",
                column: "TagId");
