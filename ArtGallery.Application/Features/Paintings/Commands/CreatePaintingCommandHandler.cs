...
public class CreatePaintingCommandHandler : IRequestHandler<CreatePaintingCommand, CreatePaintingCommandResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var createdPainting = await _unitOfWork.PaintingRepository.GetPaintingWithDetailsAsync(painting.Id);
            response.Painting = _mapper.Map<PaintingDto>(createdPainting);
        }
        catch (Exception ex)
        {
